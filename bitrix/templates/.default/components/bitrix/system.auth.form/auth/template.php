...
<?endforeach?>
	...
	<input placeholder="<?=GetMessage("AUTH_LOGIN")?>:"  type="text" name="USER_LOGIN" value="">
	...
	<input  placeholder="<?=GetMessage("AUTH_PASSWORD")?>"  type="password" name="USER_PASSWORD" autocomplete="off">
